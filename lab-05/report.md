...
subtitle: "Модель хищник-жертва - вариант 2"
...
$$
 \begin{cases}
	\frac{dx}{dt} = -0.13x(t) + 0.042y(t)x(t)
	\\   
	\frac{dy}{dt} = 0.33y(t) - 0.03y(t)x(t)
 \end{cases}
$$
...
Стационарное состояние $x_0=\frac{a}{b}=3.095, y_0=\frac{c}{d}=11$
